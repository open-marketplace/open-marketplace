...
Feature: Vendor can update his company information
  ...
  Scenario: Filling the form
    ...
    And I fill in "profile_companyName" with "Test name"
    And I fill in "profile_taxIdentifier" with "test identifier"
    And I fill in "profile_bankAccountNumber" with "PL75109024025475369832689779"
    And I fill in "profile_phoneNumber" with "test number"
    And I fill in "profile_description" with "description"
    And I fill in "profile_vendorAddress_city" with "City"
    And I fill in "profile_vendorAddress_street" with "test street"
    And I fill in "profile_vendorAddress_postalCode" with "22-332"
  ...
  Scenario: Filling the form with logo that fails file size validation
    ...
    And I fill in "profile_bankAccountNumber" with "PL75109024025475369832689779"
    And I fill in "profile_phoneNumber" with "test number"
    And I attach the file "images/too_big_image.jpg" to "profile_image_file"
    And I fill in "profile_description" with "description"
    And I fill in "profile_vendorAddress_city" with "City"
    And I fill in "profile_vendorAddress_street" with "test street"
    And I fill in "profile_vendorAddress_postalCode" with "22-332"
