...
class ManagingProductsContext implements Context
{
     ...
     */
    public function iSelectValueInLanguageForTheAttribute(
        string $value,
        string $language,
        string $attribute
    ): void {
     ...
     */
    public function itsAttributeShouldBe(
        $attributeName,
     ...
     */
    public function itsSelectAttributeShouldBe(
        $attributeName,
        ProductInterface $product,
        $value,
        $language = 'en_US'
     ...
     */
    public function itsNonTranslatableAttributeShouldBe(
     ...
     */
    public function productSlugShouldBe(
        ProductInterface $product,
        $slug,
        $locale = 'en_US'
    ) {
     ...
     */
    public function iShouldBeNotifiedThatPriceHasToBeValidAmount(): void
    {
        Assert::oneOf(
            $this->updateSimpleProductPage->getValidationMessageForPriceField(),
            [
     ...
     */
    public function itShouldBePricedAtForChannel(
        ProductInterface $product,
        string $price,
     ...
     */
    public function itsOriginalPriceForChannel(
        ProductInterface $product,
