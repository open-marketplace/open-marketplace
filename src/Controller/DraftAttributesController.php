...
final class DraftAttributesController extends ResourceController
{
    ...
    private ObjectOwningVoter $objectOwningVoter;
    ...
    public function __construct(
        ...
        ObjectOwningVoter $objectOwningVoter
    ) {
        parent::__construct(
            $metadata,
        ...
        $this->objectOwningVoter = $objectOwningVoter;
    }
    ...
    public function updateAction(Request $request): Response
    {
        ...
        $object = $this->findOr404($configuration);
        $this->denyAccessUnlessGranted(ObjectOwningVoter::OWNIT, $object);
        return parent::updateAction($request); // TODO: Change the autogenerated stub
    }
