...
class getSylius_Repository_ChannelPricingService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.channel_pricing'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Component\\Core\\Model\\ChannelPricing');
    }
}
