...
class getSylius_Repository_ProductVariantTranslationService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.product_variant_translation'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Component\\Product\\Model\\ProductVariantTranslation');
    }
}
