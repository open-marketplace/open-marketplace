 ...
 */
class getWebpackEncore_EntrypointLookupskeletonShopService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'webpack_encore.entrypoint_lookup[skeleton_shop]' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup[skeleton_shop]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup((\dirname(__DIR__, 4).'/public/build/bitbag/skeleton/shop/entrypoints.json'), NULL, 'skeleton_shop', true);
    }
}
