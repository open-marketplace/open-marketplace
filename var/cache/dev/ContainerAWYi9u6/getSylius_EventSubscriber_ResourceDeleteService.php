...
class getSylius_EventSubscriber_ResourceDeleteService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.event_subscriber.resource_delete'] = new \Sylius\Bundle\AdminBundle\EventListener\ResourceDeleteSubscriber(($container->services['router'] ?? $container->getRouterService()), ($container->services['.container.private.session'] ?? $container->get_Container_Private_SessionService()));
    }
}
