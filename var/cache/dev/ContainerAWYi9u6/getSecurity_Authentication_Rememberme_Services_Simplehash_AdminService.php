 ...
 */
class getSecurity_Authentication_Rememberme_Services_Simplehash_AdminService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), $container->getEnv('APP_SECRET'), 'admin', ['path' => '/'.$container->getEnv('string:resolve:SYLIUS_ADMIN_ROUTING_PATH_NAME'), 'name' => 'APP_ADMIN_REMEMBER_ME', 'lifetime' => 31536000, 'remember_me_parameter' => '_remember_me', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'samesite' => NULL, 'always_remember_me' => false], ($container->privates['monolog.logger.security'] ?? $container->load('getMonolog_Logger_SecurityService')));
    }
}
