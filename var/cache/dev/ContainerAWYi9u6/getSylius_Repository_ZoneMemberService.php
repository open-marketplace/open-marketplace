...
class getSylius_Repository_ZoneMemberService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.zone_member'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Component\\Addressing\\Model\\ZoneMember');
    }
}
