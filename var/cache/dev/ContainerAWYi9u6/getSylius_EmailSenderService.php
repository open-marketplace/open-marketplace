...
class getSylius_EmailSenderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.email_sender'] = new \Sylius\Component\Mailer\Sender\Sender(($container->services['sylius.email_renderer.adapter.twig'] ?? $container->load('getSylius_EmailRenderer_Adapter_TwigService')), ($container->services['sylius.email_sender.adapter.swiftmailer'] ?? $container->load('getSylius_EmailSender_Adapter_SwiftmailerService')), ($container->services['sylius.email_provider'] ?? $container->load('getSylius_EmailProviderService')), ($container->services['sylius.mailer.default_settings_provider'] ?? ($container->services['sylius.mailer.default_settings_provider'] = new \Sylius\Component\Mailer\Provider\DefaultSettingsProvider('Example.com', 'no-reply@example.com'))));
    }
}
