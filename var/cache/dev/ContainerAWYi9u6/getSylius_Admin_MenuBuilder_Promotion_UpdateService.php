...
class getSylius_Admin_MenuBuilder_Promotion_UpdateService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.admin.menu_builder.promotion.update'] = new \Sylius\Bundle\AdminBundle\Menu\PromotionUpdateMenuBuilder(($container->services['knp_menu.factory'] ?? $container->load('getKnpMenu_FactoryService')), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
    }
}
