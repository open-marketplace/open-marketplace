 ...
 */
class getWebpackEncore_EntrypointLookupskeletonAdminService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'webpack_encore.entrypoint_lookup[skeleton_admin]' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup[skeleton_admin]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup((\dirname(__DIR__, 4).'/public/build/bitbag/skeleton/admin/entrypoints.json'), NULL, 'skeleton_admin', true);
    }
}
