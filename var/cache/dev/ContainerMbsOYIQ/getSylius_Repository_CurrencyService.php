...
class getSylius_Repository_CurrencyService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.currency'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Component\\Currency\\Model\\Currency');
    }
}
