...
class getSylius_Repository_ShipmentUnitService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.shipment_unit'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Component\\Core\\Model\\OrderItemUnit');
    }
}
