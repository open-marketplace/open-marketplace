...
class getSylius_Repository_GatewayConfigService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.gateway_config'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Bundle\\PayumBundle\\Model\\GatewayConfig');
    }
}
