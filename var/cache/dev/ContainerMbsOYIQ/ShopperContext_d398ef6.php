...
class ShopperContext_d398ef6 extends \Sylius\Component\Core\Context\ShopperContext implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer1e0f3 && ($this->initializer1e0f3->__invoke($valueHolderacfd2, $this, 'getChannel', array(), $this->initializer1e0f3) || 1) && $this->valueHolderacfd2 = $valueHolderacfd2;

        return $this->valueHolderacfd2->getChannel();
    }

    public function getCurrencyCode() : string
    {
        $this->initializer1e0f3 && ($this->initializer1e0f3->__invoke($valueHolderacfd2, $this, 'getCurrencyCode', array(), $this->initializer1e0f3) || 1) && $this->valueHolderacfd2 = $valueHolderacfd2;

        return $this->valueHolderacfd2->getCurrencyCode();
    }

    public function getLocaleCode() : string
    {
        $this->initializer1e0f3 && ($this->initializer1e0f3->__invoke($valueHolderacfd2, $this, 'getLocaleCode', array(), $this->initializer1e0f3) || 1) && $this->valueHolderacfd2 = $valueHolderacfd2;

        return $this->valueHolderacfd2->getLocaleCode();
    }

    public function getCustomer() : ?\Sylius\Component\Customer\Model\CustomerInterface
    {
        $this->initializer1e0f3 && ($this->initializer1e0f3->__invoke($valueHolderacfd2, $this, 'getCustomer', array(), $this->initializer1e0f3) || 1) && $this->valueHolderacfd2 = $valueHolderacfd2;

        return $this->valueHolderacfd2->getCustomer();
    }
    ...
    public function __construct(private \Sylius\Component\Channel\Context\ChannelContextInterface $channelContext, private \Sylius\Component\Currency\Context\CurrencyContextInterface $currencyContext, private \Sylius\Component\Locale\Context\LocaleContextInterface $localeContext, private \Sylius\Component\Customer\Context\CustomerContextInterface $customerContext)
    {
        static $reflection;
        ...
        $this->valueHolderacfd2->__construct($channelContext, $currencyContext, $localeContext, $customerContext);
    }
