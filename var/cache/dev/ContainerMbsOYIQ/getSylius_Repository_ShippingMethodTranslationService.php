...
class getSylius_Repository_ShippingMethodTranslationService extends App_KernelDevDebugContainer
{
    ...
    {
        return $container->services['sylius.repository.shipping_method_translation'] = ($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService())->getRepository('Sylius\\Component\\Shipping\\Model\\ShippingMethodTranslation');
    }
}
