...
class getSylius_Repository_OrderItemService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.repository.order_item'] = new \Sylius\Bundle\CoreBundle\Doctrine\ORM\OrderItemRepository($a, $a->getClassMetadata('BitBag\\SyliusMultiVendorMarketplacePlugin\\Entity\\OrderItem'));
    }
}
