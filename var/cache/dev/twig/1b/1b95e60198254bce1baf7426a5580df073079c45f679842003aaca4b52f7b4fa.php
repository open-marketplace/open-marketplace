...
class __TwigTemplate_a0b3dc32dfc579bfa4f5907e52bde90545beb8b0889b099753668d1bcb9443bb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 5
        if (twig_in_filter(twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 5, $this->source); })()), "paymentState", [], "any", false, false, false, 5), [0 => "awaiting_payment"])) {
            // line 6
            echo "    ";
...
{% endif %}
", "@SyliusShop/Account/Order/Grid/Action/pay.html.twig", "/home/raf/Pulpit/Praca/SyliusMultiVendorMarketplacePlugin/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/Order/Grid/Action/pay.html.twig");
    }
}
