...
class __TwigTemplate_3813b1d16fc7bd56ffce2dcee538271d9a40cf044e0927ed5156553c524a6425 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"thirteen wide column\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 23
            echo "                ";
            $this->loadTemplate(twig_get_attribute($this->env, $this->source, $context["item"], "attribute", [0 => "template"], "method", false, false, false, 23), "@SyliusAdmin/ProductVariant/_menu.html.twig", 23)->display(twig_array_merge($context, ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "product_variant" => twig_get_attribute($this->env, $this->source, (isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 23, $this->source); })()), "product_variant", [], "any", false, false, false, 23)]));
            // line 24
            echo "            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
{% endblock %}
", "@SyliusAdmin/ProductVariant/_menu.html.twig", "/home/raf/Pulpit/Praca/SyliusMultiVendorMarketplacePlugin/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/ProductVariant/_menu.html.twig");
    }
}
