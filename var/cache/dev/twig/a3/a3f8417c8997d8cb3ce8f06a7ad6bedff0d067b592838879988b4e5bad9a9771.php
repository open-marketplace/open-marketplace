...
class __TwigTemplate_147ff231de0aa23b1355368cd9bdcd09b48b59fce3ddd93adf1d55b93eb01d1c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"column\">
        ...
        ";
        // line 6
        echo $this->extensions['Sylius\Bundle\UiBundle\Twig\TemplateEventExtension']->render([0 => ((isset($context["event_prefix"]) || array_key_exists("event_prefix", $context) ? $context["event_prefix"] : (function () { throw new RuntimeError('Variable "event_prefix" does not exist.', 6, $this->source); })()) . ".header"), 1 => "sylius.admin.index.header"], $context);
        echo "
    </div>
...
", "@SyliusAdmin/Crud/Index/_header.html.twig", "/home/raf/Pulpit/Praca/SyliusMultiVendorMarketplacePlugin/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Crud/Index/_header.html.twig");
    }
}
