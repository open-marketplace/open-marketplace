...
class __TwigTemplate_a6a15767c431b0c8b9654c712b742194d1e8d2f08417ce842362e0f3988f7c4c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_dump_request_data($__token__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 156
            $macros["__internal_parse_33"] = $this;
            // line 157
            echo "{
    id: \"";
            // line 158
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_33"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/home/raf/Pulpit/Praca/SyliusMultiVendorMarketplacePlugin/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
}
