...
require_once __DIR__.\DIRECTORY_SEPARATOR.'AwsS3'.\DIRECTORY_SEPARATOR.'OptionsConfig.php';
...
class AwsS3Config 
{
    ...
    public function options(array $value = []): \Symfony\Config\KnpGaufrette\AdapterConfig\AwsS3\OptionsConfig
    {
        if (null === $this->options) {
            $this->_usedProperties['options'] = true;
            $this->options = new \Symfony\Config\KnpGaufrette\AdapterConfig\AwsS3\OptionsConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('options', $value)) {
            $this->_usedProperties['options'] = true;
            $this->options = new \Symfony\Config\KnpGaufrette\AdapterConfig\AwsS3\OptionsConfig($value['options']);
            unset($value['options']);
        }
