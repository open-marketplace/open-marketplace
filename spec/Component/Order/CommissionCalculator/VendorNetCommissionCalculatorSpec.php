...
use BitBag\OpenMarketplace\Component\Order\CommissionCalculator\VendorNetCommissionCalculator;
use BitBag\OpenMarketplace\Component\Order\Entity\OrderInterface;
use BitBag\OpenMarketplace\Entity\VendorInterface;
use PhpSpec\ObjectBehavior;

class VendorNetCommissionCalculatorSpec extends ObjectBehavior
{
    public function it_is_initializable(): void
    {
        $this->shouldHaveType(VendorNetCommissionCalculator::class);
    ...
    public function it_returns_false_on_unsupported_commission_type(OrderInterface $order, VendorInterface $vendor): void
    {
        ...
        $vendor->getCommissionType()->willReturn('gross');
