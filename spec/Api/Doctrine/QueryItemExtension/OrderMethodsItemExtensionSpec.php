...
use BitBag\OpenMarketplace\Api\Doctrine\QueryItemExtension\OrderMethodsItemExtension;
...
final class OrderMethodsItemExtensionSpec extends ObjectBehavior
{
    public function let(
        ...
        $this->beConstructedWith($baseOrderMethodsItemExtension, $sectionProvider);
    }
